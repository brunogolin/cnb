...
public class ApiResponseMessages {
    ...
    public static final String MESSAGE_202 = "The request has been accepted but the processing has not been completed yet";
    public static final String MESSAGE_204 = "Successful request without body content";

    public static final String MESSAGE_400 = "The request was invalid or could not be served. An accompanying error message will explain further";
    ...
    public static final String MESSAGE_500 = "Something went wrong on the server. An accompanying error message will explain further";
}
